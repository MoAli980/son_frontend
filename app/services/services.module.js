...
const development = 'http://35.183.44.83:3000';
const host = development;

const servicesModule = angular.module('app.servicesModule', []);
servicesModule.constant('AppConstants', {
    api: `${host}/api`,
    googleMapsUrl: 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAVyrPpRVpBYwmDTYzZk0v0hp7B3KuhKpc?libraries=places',
    JwtKey: 'JwtKey',
...
servicesModule.factory('RetryRequest', ['$http', '$q', '$rootScope', '$window', function ($http, $q, $rootScope, $window) {
